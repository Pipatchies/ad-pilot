          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className='text-lg font-semibold'>Nom de la campagne</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='flex-1 min-w-[170px]'>
                    <FormLabel className='text-lg font-semibold'>Importez votre brief</FormLabel>
                    <FormControl>
                      <div className='relative'>
                        <Input
                          ...
                          onClick={() => document.getElementById('hiddenBriefInput')?.click()}
                        />
                        <SvgUploder
