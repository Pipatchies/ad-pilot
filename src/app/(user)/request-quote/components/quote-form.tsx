...
export default function QuoteForm() {
  ...
  const createQuote = useMutation(api.mutations.quotes.createQuote);
              ...
              {fields.map((field, index) => (
                <div key={field.id} className='space-y-6 relative'>
                  <div className='flex justify-between items-center mb-4'>
                    <h3 className='text-xl font-bold text-primary'>Média #{index + 1}</h3>
                  </div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className='text-lg font-semibold'>Régie concernée</FormLabel>
                          <FormControl>
                            <Input
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className='text-lg font-semibold'>Le format</FormLabel>
                          <FormControl>
                            <Input
                            ...
                            <PopoverTrigger asChild>
                              <div
                                className={cn(
                                  ...
                                  'border',
                                  !field.value?.from ? 'text-primary/50' : 'text-primary',
                                  'border-[#A5A4BF]',
                                )}
                              >
