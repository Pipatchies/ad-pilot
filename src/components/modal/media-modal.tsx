...
export default function MediaModal({ onAddMedia }: MediaModalProps) {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const resourceType = tableType === 'mp4' ? 'video' : tableType === 'mp3' ? 'raw' : 'image';
    ...
    children: (
      <Form {...form}>
        ...
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='w-1/2'>
                  <FormLabel className='text-lg font-semibold'> Titre du média</FormLabel>
                  <FormControl>
                    <Input
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger className='w-full text-base italic rounded-sm border border-[#A5A4BF] p-5 bg-white'>
                        <SelectValue
                          placeholder={
                            <span className='text-primary/50 italic'>Choisir le type</span>
                          }
                        />
                      </SelectTrigger>
                    </FormControl>
          ...
          <FormItem>
            <FormLabel className='text-lg font-semibold'>Importer le média</FormLabel>
            <FormControl>
            ...
            <p className='text-sm text-destructive italic'>Poids max. 500 Mo</p>
            <FormMessage />
          </FormItem>
        </form>
      </Form>
